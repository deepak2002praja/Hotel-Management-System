...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">deepakpraj159@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 (75)350-58-031</li>	
					<li class="s-bar">
						<div class="search">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">Unlock your dream getaway with seamless hotel room bookings.</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 (75)3505-80-31</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="deepakpraj159@gmail.com">deepakpraj159@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Jaypee University Of Engineering & Technology, Guna</p>
